...
CREATE TABLE `users` (
  ...
  `buyer_mail` VARCHAR(190) NOT NULL DEFAULT 'yu.y.zhang@jos.com' COMMENT 'ePortal采购人邮箱',
  `buyer` VARCHAR(120) NOT NULL DEFAULT 'Yu y Zhang' COMMENT 'ePortal采购人',
  `buyer_boss` VARCHAR(120) NOT NULL DEFAULT 'Candice Wu' COMMENT 'ePortal采购主管',
  `buyer_boss_mail` VARCHAR(190) NOT NULL DEFAULT 'candice.wu@jos.com' COMMENT 'ePortal采购主管邮箱',
  `ratifier` VARCHAR(120) NOT NULL DEFAULT 'Joan Liu' COMMENT 'ePortal批准人',
  `ratifier_mail` VARCHAR(190) NOT NULL DEFAULT 'joan.liu@jos.com' COMMENT 'ePortal批准人邮箱',
